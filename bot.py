...
class Susbot:
    ...
    async def on_message(message: str) -> None:
        ...
        easter_eggs = {
            ...
            "i use arch btw": """
                            Listen you filthy winbloats normie, you're probably used to sucking off proprietary dicks with all proprietary bullshit that's on your computer. I, being the obvious next evolution of you, use GNU/Linux. My computer is a beautiful peace of Free and Open Source Software, or as I've recently started calling it Libre Software.

Last time I checked I didn't have cortana bloat spying on me like the fucking Microsoft SIMP she is. If Jesus was an OS he would definitely be GNU/Linux. In ancient scribes found in the library of Alexandria, it has been proven that the GNU/Linux is better than winbloats. Since then the most popular porn site has been r/unixporn

Enjoy your normie life as winbloats user while my GNU/Linux runs a helicopter on mars as well as a toaster in my kitchen. My whole life is FOSS and I am now more FREE than America.
                              """,
